...
* **aFRR data**: We have used publicly available [aFRR data](regelleistung.net/) as an input to `2_stability_indicator_prep.py`. The raw aFRR data files are also available on our accompanying [zenodo repository](https://doi.org/10.5281/zenodo.5497500). The raw aFRR data is supposed to reside in `./data/DE/frr_data/`. 
